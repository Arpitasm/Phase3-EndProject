...
public class Assignment002Demo {
	...
	public void assignment002Post() {
		...
		File file = new File(
				"C:\\Users\\Exam\\eclipse-workspace\\Phase3-PhaseEndProject\\Phase3-EndProject\\src\\main\\resourse\\data.json");
	...
	public void assignment002Put() {
		File file = new File(
				"C:\\Users\\Exam\\eclipse-workspace\\Phase3-PhaseEndProject\\Phase3-EndProject\\src\\main\\resourse\\dataput.json");
		int id = RestAssured.given().baseUri("https://petstore.swagger.io/v2/pet/").contentType(ContentType.JSON)
